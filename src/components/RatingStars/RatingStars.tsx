        ...
        .map((_, index) => {
          return (
            <li className='p-2' key={index}>
              <div onClick={() => handleFilterStar(5 - index)} className='flex cursor-pointer items-center' aria-hidden>
                {Array(5)
                  .fill(0)
                  .map((_item, indexStars) => {
                ...
                {index !== 0 && <span className='ml-1 text-sm text-gray-600'>Or higher</span>}
              </div>
            </li>
          )
        })}
