      ...
      <div className='min-h-screen flex items-center justify-center p-4'>
        ...
        <div className='bg-white shadow-md rounded-lg w-full max-w-md p-8'>
          ...
          <form onSubmit={onSubmit}>
            ...
            <Button
              children={'Sign in'}
              className='w-full justify-center gap-2 flex items-center bg-blue-600 text-white py-2 rounded-md mt-2 cursor-pointer hover:bg-blue-700 transition-all'
          ...
          {/* Google Button */}
          <button className='w-full border border-gray-300 py-2 rounded-md hover:bg-gray-100 transition-all cursor-pointer flex items-center justify-center gap-2'>
          ...
          <p className='text-center text-sm text-gray-600 mt-6'>
            New to eBay?
            <NavLink to={path.register} className='text-blue-600 hover:underline ml-1'>
              Create an account
            </NavLink>
          </p>
        </div>
